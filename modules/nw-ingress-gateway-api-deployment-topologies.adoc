...
Gateway API is designed to accomodate two topologies: shared gateways or dedicated gateways. Each topology hastheir own advantages and as well as different security implications.
